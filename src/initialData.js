...
class ItemsConvertor {
    ...
    getPage(page = this.page) {
        return this.items.slice(page * this.pageSize,
            page * this.pageSize + this.pageSize);
    }

    getSortedRows(field='mass', order = 'asc') {
        if (!Object.keys(data.titles).includes(field) ||
